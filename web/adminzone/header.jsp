...
<div class="row row1">
                <div class="col-sm-1" style="min-height: 70px;background-color: aqua;">
                </div>
                <div class="col-sm-11 text-light fw-bold" style="min-height: 70px;background-color: #2d3047;text-shadow: 0 0 5px white;font-size: 3vw; text-align: center;line-height: 70px;">
                    Hukmawati Cold Storage Pvt Ltd
                    <span class="h5">Fatehpur, Barabanki</span>
                </div>
            </div>
