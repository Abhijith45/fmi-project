...
<html>
    ...
    <body style="background-color: #2d3047; overflow-x:hidden;">
...
<!--First slider end-->
            ...
            <div class="row" style="min-height: 500px;">
                <div class="col-sm-3 bg-white" id="newsbox" style="height: 500px;">
                    <div class="bg-primary py-2 mt-2 ms-1" style="width: 100%;text-align: center;">
                        <a href="#" class="text-decoration-none text-white h5">News & Events</a>
                    </div>
                  <marquee direction="up" scrollamount="3" class="news-content text-danger" style="width: 100%;height: 90%;">
                      <ul>
                          <%
                          ResultSet rss=dm.select("select * from news");
                          while(rss.next()){
                          %>
                          <li><a href="#" class="fw-bold"><%=rss.getString("newstext")%></a> </li>
                          <% } %>
                      </ul>
                  </marquee>
                </div>
                <div class="col-sm-9 bg-secondary" style="min-height:250px;" >
                    <div class="row" id="bagdes">
                    ...
                    <div class="row ">     
                        ...
                        <div class="row px-0 mx-0 content1" style="padding-left: 5%;">
                        ...
                        <div style="width: 95%;">
                            <label class="bg-primary mx-auto mb-3 py-1 fw-bold text-white label1" style="width:150px;display:block;text-align:center;" for="check1">Click me</label>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="row ps-5">                             
                        ...
                        <div class="row px-0 mx-0 content2" style="padding-left: 5%;">                         
                    <div class="card m-4 pt-3" style="width: 18rem;">
                        <a href="#">
                    ...
                    <div class="card m-4 pt-3" style="width: 18rem;">
                        ...
                        <div style="width: 95%;">
                            <label class="bg-primary mx-auto mb-3 py-1 fw-bold text-white label2" style="width:150px;display:block;text-align:center;" for="check2">Click me</label>
                        </div>
                    </div>
                    </div>
                </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
    ...
    <span class="visually-hidden">Next</span>
            ...
            <div class="row bg-white" style="min-height: 400px;">
                <div class="col-sm-12">
                    <img src="images/silder_8.jpg" style="width:100%;"/>
                </div>
            </div>
